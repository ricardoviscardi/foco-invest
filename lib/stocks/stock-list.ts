...
export const stockSuggestionsFallback: StockSearchFallback[] = [
  ...
  { symbol: "ELET3", name: "Eletrobras ON", sector: "Energia Elétrica" },
  ...
  { symbol: "BRFS3", name: "BRF ON", sector: "Alimentos" },
  { symbol: "MRVE3", name: "MRV ON", sector: "Construção" },
  { symbol: "CYRE3", name: "Cyrela ON", sector: "Construção" },
  { symbol: "NTCO3", name: "Natura ON", sector: "Consumo" },
  { symbol: "EMBR3", name: "Embraer ON", sector: "Aeronáutico" },
